...
class MouseDetectorItem extends StatefulWidget {
  const MouseDetectorItem({
    Key? key,
    required this.child,
    required this.onTap,
  }) : super(key: key);
  ...
  @override
  State<MouseDetectorItem> createState() =>
      _RecipeListItemGestureDetectorState();
}

class _RecipeListItemGestureDetectorState extends State<MouseDetectorItem>
